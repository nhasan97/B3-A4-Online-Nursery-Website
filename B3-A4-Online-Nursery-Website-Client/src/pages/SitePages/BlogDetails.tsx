        ...
        <div className="w-full min-h-screen">
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col lg:flex-row gap-6">
              <div className="w-full flex flex-col gap-6 text-[#757575] py-5">
                <div>
            ...
            <div className="w-fit py-1 px-3 rounded-full bg-white text-pink-500">
              ...
              <div className="w-full lg:w-1/3 lg:pl-5 lg:border-l lg:border-[#e1e2e1] space-y-6">
                ...
                <div className="w-full space-y-6 pb-5">
                  {loadingTopBlogs ? (
                    ...
                    topBlogs?.map((blog) => (
                      <div
                        key={blog._id}
                        className="bg-[#ECF1EC] p-2 rounded-lg"
                      >
                        <div className="flex items-center gap-3">
                          <img
                            src={blog?.thumbnail}
