...
const Register = () => {
  ...
  return (
    <div className="h-screen flex justify-center items-center bg-[url('/public/loginRegBG.png')]  bg-[rgba(20,20,20,0.73)] bg-no-repeat bg-center bg-cover bg-blend-overlay bg-fixed">
      <Container>
        <div className="w-full bg-[#f4f3f081] p-5 sm:p-10 space-y-6 rounded-lg backdrop-blur-sm">
          ...
          <div className="flex flex-col justify-center items-center mt-5 space-y-5">
            <p className="text-base font-medium">
              ...
              <Link className="ml-1 text-red-700" to="/login">
                log in
              </Link>
            </p>
          </div>
