...
const ProductTableRow = () => {
  return (
    <tr className="flex justify-between items-center text-[#757575] text-center p-5 border-b">
      ...
      <td className="flex-1">
        <Button className="bg-transparent hover:bg-red-100 text-[#757575] hover:text-red-600">
          <svg
