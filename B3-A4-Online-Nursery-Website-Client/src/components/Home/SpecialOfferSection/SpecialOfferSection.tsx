...
const SpecialOfferSection = () => {
  return (
    <div className="bg-[#547256] my-10 md:my-20">
      <Container>
        <div className="w-full h-full flex flex-col md:flex-row gap-8 sm:gap-16">
          <div className="w-full md:w-1/2 h-full bg-white px-5">
            <img src={offer} className="w-full" />
          </div>

          <div className="w-full md:w-1/2 flex flex-col justify-center items-center gap-6 p-5 text-center text-white lg:bg-[url(../public/palm2.png)] bg-no-repeat bg-right-top bg-auto">
